...
public class ViewPriceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isLetter1Matched = intent.getBooleanExtra("IsLetterMatched", false); // Mahajana Sampatha සහ NLB Jaya සඳහා
        boolean isLetter2Matched = intent.getBooleanExtra("IsLetter2Matched", false); // Dhana Nidhanaya සඳහා
        boolean is5DigitMatched = intent.getBooleanExtra("Is5DigitMatched", false); // Dhana Nidhanaya සඳහා
        boolean isBonusMatched = intent.getBooleanExtra("IsBonusMatched", false); // Mega Power සඳහා
        int matchedDigits = intent.getIntExtra("MatchedDigits", 0); // Mahajana Sampatha සඳහා
        ...
        calculateAndDisplayPrize(lotteryName, matchedNumbersCount, isLetter1Matched, isLetter2Matched, is5DigitMatched, isBonusMatched, nlbJayaMatchType, nlbForwardMatchCount, nlbBackwardMatchCount, matchedDigits);
    ...
    private void calculateAndDisplayPrize(String lotteryName, int matchedCount, boolean letter1Matched, boolean letter2Matched, boolean fiveDigitMatched, boolean bonusMatched, String nlbJayaMatchType, int forwardCount, int backwardCount, int matchedDigits) {
        ...
        switch (lotteryName) {
            ...
            case "Govi Setha":
                ...
                else if (matchedCount == 3 && letter1Matched && letter2Matched) prizeMessage = "Rs. 250,040";
                else if (matchedCount == 3 && letter1Matched) prizeMessage = "Rs. 250,000";
                else if (matchedCount == 3 && letter2Matched) prizeMessage = "Rs. 5,040";
                else if (matchedCount == 3) prizeMessage = "Rs. 5,000";
                else if (matchedCount == 2 && letter1Matched) prizeMessage = "Rs. 2,000";
                else if (matchedCount == 2 && letter2Matched) prizeMessage = "Rs. 240";
                else if (matchedCount == 2) prizeMessage = "Rs. 200";
                else if (matchedCount == 1 && letter1Matched && letter2Matched) prizeMessage = "Rs. 240";
                else if (matchedCount == 1 && letter1Matched) prizeMessage = "Rs. 200";
            ...
            case "Mahajana Sampatha":
                if (forwardCount >= backwardCount) {
                    if (forwardCount == 6 && letter1Matched) prizeMessage = "Super Jackpot!";
                    else if (forwardCount == 6) prizeMessage = "Rs. 2,500,000";
                    else if (forwardCount == 5) prizeMessage = "Rs. 100,000";
                    else if (forwardCount == 4) prizeMessage = "Rs. 2,000";
                    ...
                    if (backwardCount == 5) prizeMessage = "Rs. 100,000";
                    else if (backwardCount == 4) prizeMessage = "Rs. 15,000";
            ...
            case "NLB Jaya":
                if (forwardCount >= backwardCount) {
                    if (forwardCount == 4 && letter1Matched) prizeMessage = "500,000";
                    else if (forwardCount == 4) prizeMessage = "Rs. 50,000";
                    else if (forwardCount == 3) prizeMessage = "Rs. 200 ";
                    else if (forwardCount == 2) prizeMessage = "Rs. 80";
                    else if (forwardCount == 1) prizeMessage = "Rs. 40";
                    else if (letter1Matched) prizeMessage = "Rs. 40";
